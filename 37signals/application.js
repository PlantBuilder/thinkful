...
//        $("div#overlay").html( "left: " + Math.floor(offset.left) + ", top: " + Math.floor(offset.top) );
          ...
          $("div.hero").css({'fontSize':'28pt', 'marginTop': '17px','marginBottom':'23px'});
          ...
          $("div.subtext").css({'fontFamily':'arial','fontWeight':'500','fontSize':'11pt', 'marginTop': '13px','marginBottom':'16px'});
  ...
  //      $("div.col-1-3").css({paddingTop: '2px'});
    ...
    $(".module").mouseleave(function(){
        $("div.hero").html('Making collaboration productive and <br>' +
            'enjoyable for people every day.');
